...
#   bash run_all_checkpoints.sh <MODEL_DIR> all          # 上記すべて
#
# 期待するディレクトリ構造:
#   <MODEL_DIR>/
#     global_step_50/
...
CONFIG="$WORK_DIR/src/config.yaml"
CONFIG_BAK="$WORK_DIR/src/config.yaml.bak"

# GRPO 後のモデル配置ルート (global_step_* を含むディレクトリ)
DEFAULT_MODEL_DIR="/work/UTSUROLB/utlb_buma2/work_grpo/ckpts/verl_grpo_qwen3_4b_qe_wmt21_enja/0_862057_nqsv"
...
echo "config.yaml をバックアップしました: $CONFIG_BAK"
